...
import cbox.yunkang.com.c_box.SpinningApplication;import okhttp3.Cache;
...
public class OkHttpUtil {
    ...
    public OkHttpClient getOkHttpClient(){
        Cache cache = new Cache(new File(SpinningApplication.Companion.getContext().getCacheDir().getAbsolutePath(),"HttpCache"),1024 * 1024 * 10);
    ...
    public static boolean isNetWorkAvailable(){
        ConnectivityManager connectivityManager = (ConnectivityManager) SpinningApplication.Companion.getContext()
