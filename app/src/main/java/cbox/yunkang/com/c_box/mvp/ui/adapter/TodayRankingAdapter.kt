...
class TodayRankingAdapter : RecyclerView.Adapter<TodayRankingAdapter.RankingViewHolder> {
    ...
    var list : List<cbox.yunkang.com.c_box.mvp.datamodel.TodayRanking> ?= null
               set(value) {
                   field = value
    ...
    constructor(context: Context , list: List<cbox.yunkang.com.c_box.mvp.datamodel.TodayRanking>){
