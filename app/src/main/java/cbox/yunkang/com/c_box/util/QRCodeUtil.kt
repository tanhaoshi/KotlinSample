...
object QRCodeUtil {
     ...
     */
    internal fun encodeAsBitmap(contents: String,
     ...
     * @return
     */
    internal fun creatCodeBitmap(contents: String, width: Int,
     ...
     * @return
     */
    internal fun mixtureBitmap(first: Bitmap?, second: Bitmap?,
